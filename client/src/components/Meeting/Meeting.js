        ...
        myPeer.on("open", (peerId) => {
            ...
            getUserDataStream()
                .then((stream) => {
                    ...
                    socket.emit("join", { name: parsedName, room: parsedRoom, peerId }, (data) => {
                        console.log(data);
    ...
    return (
        <React.Fragment>
            ...
            <div className="videoGrid">
                <VideoScreen>
                    <video ref={myVideoRef} className="myCamera" />
                </VideoScreen>
                {usersInCall.map((user, i) => (
                    <VideoScreen userName={user}>
                        <video className="videoRefStyle" key={i} ref={setVideosRef(user)}></video>
                    </VideoScreen>
                ))}
            </div>
